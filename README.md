...
# The Void Nitro live image/rootfs generator and installer

## Overview

This repository contains several utilities:

* [*mklive.sh*](#mklivesh) - The Void Nitro live image generator for x86
* [*mkiso.sh*](#mkisosh) - Wrapper script to generate bootable and installable live
  images for i686, x86_64, and aarch64.
* [*mkrootfs.sh*](#mkrootfssh) - The Void Nitro rootfs generator for all platforms
* [*mkplatformfs.sh*](#mkplatformfssh) - The Void Nitro filesystem tool to produce
  a rootfs for a particular platform
* [*mkimage.sh*](#mkimagesh) - The Void Nitro image generator for ARM platforms
* [*mknet.sh*](#mknetsh) - Script to generate netboot tarballs for Void
* *installer.sh* - The Void Nitro el-cheapo installer for x86
...
ROOTFS tarballs contain a basic Void Nitro root filesystem without a kernel.
...
Use [*mkrootfs.sh*](#mkrootfssh) to generate a Void Nitro ROOTFS.
...
[*mkplatformfs.sh*](#mkplatformfssh) to generate a Void Nitro PLATFORMFS.
...
Generates a platform-specific ROOTFS tarball from a generic Void Nitro ROOTFS
...
Generates a network-bootable tarball from a Void Nitro ROOTFS generated by mkrootfs.
