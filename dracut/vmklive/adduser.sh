...
# Setup default root/user password (voidnitro).
chroot ${NEWROOT} sh -c 'echo "root:voidnitro" | chpasswd -c SHA512'
chroot ${NEWROOT} sh -c "echo "$USERNAME:voidnitro" | chpasswd -c SHA512"
